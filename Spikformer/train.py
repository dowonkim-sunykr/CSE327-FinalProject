...
import shutil
# Monkey patch os.link to avoid OSError on Colab
def safe_link(src, dst):
    try:
        shutil.copy(src, dst)
        # print(f"[MonkeyPatch] Copied instead of linking: {src} → {dst}")
    except Exception as e:
        # print(f"[MonkeyPatch] Failed to copy instead of linking: {e}")
        ...
...
parser.add_argument('-c', '--config', default='my_config.yml', type=str, metavar='FILE',
...
def main():
    ...
    try:
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            print('epoch total time:', epoch_total_time, 'seconds --------------------------------')
